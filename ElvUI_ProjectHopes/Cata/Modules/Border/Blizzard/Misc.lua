...
function S:BlizzardMiscFrames()
	...
	BORDER:CreateBorder(ColorPickerFrame.OkayButton, nil, nil, nil, nil, nil, false, true)
	BORDER:CreateBorder(ColorPickerFrame.CancelButton, nil, nil, nil, nil, nil, false, true)
