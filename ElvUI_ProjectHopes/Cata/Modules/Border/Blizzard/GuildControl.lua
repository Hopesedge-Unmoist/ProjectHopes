...
function S:Blizzard_GuildControlUI()
	...
	BORDER:CreateBorder(RankSettingsFrameGoldBox, nil, nil, nil, nil, nil, false, false)
	...
	BORDER:CreateBorder(_G.GuildControlUIRankBankFrameInsetScrollFrame.ScrollBar, nil, nil, nil, nil, nil, false, true)
