...
function ProjectHopes:Config()
	...
	POAPOR.target.args.Position.args.targetPosition = ACH:Select(L["Position"], nil, 7, {["center"]="Center",["left"]="Left",["right"]="Right",["top"]="Top",["bottom"]="Bottom",["topleft"]="Top Left",["topright"]="Top Right",["bottomleft"]="Bottom Left",["bottomright"]="Bottom Right"}, nil, "medium", function() return E.db.ProjectHopes.portraits.targetPosition or "center" end, function(_, value) E.db.ProjectHopes.portraits.targetPosition = value PORTRAIT:UpdatePortrait("target",E.db.ProjectHopes.portraits.targetClassBackdropColor,E.db.ProjectHopes.portraits.targetClass,E.db.ProjectHopes.portraits.targetMirror,E.db.ProjectHopes.portraits.targetClassTexture,E.db.ProjectHopes.portraits.targetBorderColor) PORTRAIT:UpdatePosition("target",value,E.db.ProjectHopes.portraits.targetOffsetX or 0,E.db.ProjectHopes.portraits.targetOffsetY or 0) end)
	POAPOR.target.args.Position.args.targetOffsetX = ACH:Range(L["X Offset (Left/Right)"], nil, 8, {min=-200,max=200,step=1}, nil, function() return E.db.ProjectHopes.portraits.targetOffsetX or 0 end, function(_, value) E.db.ProjectHopes.portraits.targetOffsetX = value PORTRAIT:UpdatePosition("target",E.db.ProjectHopes.portraits.targetPosition or "center",value,E.db.ProjectHopes.portraits.targetOffsetY or 0) end)
	POAPOR.target.args.Position.args.targetOffsetY = ACH:Range(L["Y Offset (Down/Up)"], nil, 9, {min=-200,max=200,step=1}, nil, function() return E.db.ProjectHopes.portraits.targetOffsetY or 0 end, function(_, value) E.db.ProjectHopes.portraits.targetOffsetY = value PORTRAIT:UpdatePosition("target",E.db.ProjectHopes.portraits.targetPosition or "center",E.db.ProjectHopes.portraits.targetOffsetX or 0,value) end)
	...
	POAPOR.focus.args.Position.args.focusPosition = ACH:Select(L["Position"], nil, 7, {["center"]="Center",["left"]="Left",["right"]="Right",["top"]="Top",["bottom"]="Bottom",["topleft"]="Top Left",["topright"]="Top Right",["bottomleft"]="Bottom Left",["bottomright"]="Bottom Right"}, nil, "medium", function() return E.db.ProjectHopes.portraits.focusPosition or "center" end, function(_, value) E.db.ProjectHopes.portraits.focusPosition = value PORTRAIT:UpdatePortrait("focus",E.db.ProjectHopes.portraits.focusClassBackdropColor,E.db.ProjectHopes.portraits.focusClass,E.db.ProjectHopes.portraits.focusMirror,E.db.ProjectHopes.portraits.focusClassTexture,E.db.ProjectHopes.portraits.focusBorderColor) PORTRAIT:UpdatePosition("focus",value,E.db.ProjectHopes.portraits.focusOffsetX or 0,E.db.ProjectHopes.portraits.focusOffsetY or 0) end)
	POAPOR.focus.args.Position.args.focusOffsetX = ACH:Range(L["X Offset (Left/Right)"], nil, 8, {min=-200,max=200,step=1}, nil, function() return E.db.ProjectHopes.portraits.focusOffsetX or 0 end, function(_, value) E.db.ProjectHopes.portraits.focusOffsetX = value PORTRAIT:UpdatePosition("focus",E.db.ProjectHopes.portraits.focusPosition or "center",value,E.db.ProjectHopes.portraits.focusOffsetY or 0) end)
	POAPOR.focus.args.Position.args.focusOffsetY = ACH:Range(L["Y Offset (Down/Up)"], nil, 9, {min=-200,max=200,step=1}, nil, function() return E.db.ProjectHopes.portraits.focusOffsetY or 0 end, function(_, value) E.db.ProjectHopes.portraits.focusOffsetY = value PORTRAIT:UpdatePosition("focus",E.db.ProjectHopes.portraits.focusPosition or "center",E.db.ProjectHopes.portraits.focusOffsetX or 0,value) end)
	...
	POAPOR.targettarget.args.Position.args.targettargetPosition = ACH:Select(L["Position"], nil, 7, {["center"]="Center",["left"]="Left",["right"]="Right",["top"]="Top",["bottom"]="Bottom",["topleft"]="Top Left",["topright"]="Top Right",["bottomleft"]="Bottom Left",["bottomright"]="Bottom Right"}, nil, "medium", function() return E.db.ProjectHopes.portraits.targettargetPosition or "center" end, function(_, value) E.db.ProjectHopes.portraits.targettargetPosition = value PORTRAIT:UpdatePortrait("targettarget",E.db.ProjectHopes.portraits.targettargetClassBackdropColor,E.db.ProjectHopes.portraits.targettargetClass,E.db.ProjectHopes.portraits.targettargetMirror,E.db.ProjectHopes.portraits.targettargetClassTexture,E.db.ProjectHopes.portraits.targettargetBorderColor) PORTRAIT:UpdatePosition("targettarget",value,E.db.ProjectHopes.portraits.targettargetOffsetX or 0,E.db.ProjectHopes.portraits.targettargetOffsetY or 0) end)
	POAPOR.targettarget.args.Position.args.targettargetOffsetX = ACH:Range(L["X Offset (Left/Right)"], nil, 8, {min=-200,max=200,step=1}, nil, function() return E.db.ProjectHopes.portraits.targettargetOffsetX or 0 end, function(_, value) E.db.ProjectHopes.portraits.targettargetOffsetX = value PORTRAIT:UpdatePosition("targettarget",E.db.ProjectHopes.portraits.targettargetPosition or "center",value,E.db.ProjectHopes.portraits.targettargetOffsetY or 0) end)
	POAPOR.targettarget.args.Position.args.targettargetOffsetY = ACH:Range(L["Y Offset (Down/Up)"], nil, 9, {min=-200,max=200,step=1}, nil, function() return E.db.ProjectHopes.portraits.targettargetOffsetY or 0 end, function(_, value) E.db.ProjectHopes.portraits.targettargetOffsetY = value PORTRAIT:UpdatePosition("targettarget",E.db.ProjectHopes.portraits.targettargetPosition or "center",E.db.ProjectHopes.portraits.targettargetOffsetX or 0,value) end)
