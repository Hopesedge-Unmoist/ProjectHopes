...
function ProjectHopes:Miscellaneous()
    ...
    POAMSA.gcd.args.settings.args.historyCount = ACH:Range(L["Number of History Icons"], L["How many spell history icons to display"], 2, {min = 1, max = 10, step = 1}, nil, function() return E.db.ProjectHopes.gcd.historyCount end, function(_, value) E.db.ProjectHopes.gcd.historyCount = value if SpellHistory then SpellHistory:UpdateHistoryCount() end end)
    POAMSA.gcd.args.settings.args.iconSpacing = ACH:Range(L["Icon Spacing"], L["Adjust the spacing between icons"], 3, {min = 0, max = 50, step = 1}, nil, function() return E.db.ProjectHopes.gcd.iconSpacing or 6 end, function(_, value) E.db.ProjectHopes.gcd.iconSpacing = value if SpellHistory then SpellHistory:UpdateIconSpacing() end end)
    POAMSA.gcd.args.settings.args.keepRatio = ACH:Toggle(L["Keep Icon Ratio"], L["Keep icons square shaped. When disabled, you can set custom width and height for each icon type."], 4, nil, false, nil, function() return E.db.ProjectHopes.gcd.keepRatio end, function(_, value) E.db.ProjectHopes.gcd.keepRatio = value if SpellHistory then SpellHistory:UpdateMainIconSize() SpellHistory:UpdateHistoryIconSize() end end)
    
    -- Cast Icon Size Settings
    POAMSA.gcd.args.settings.args.mainIconHeader = ACH:Header(L["Cast Icon Size"], 10)
    POAMSA.gcd.args.settings.args.mainIconSize = ACH:Range(L["Cast Icon Size"], L["Adjust the size of the Cast Icon (square)"], 11, Private.Values.IconSize, nil, function() return E.db.ProjectHopes.gcd.mainIconSize end, function(_, value) E.db.ProjectHopes.gcd.mainIconSize = value if SpellHistory then SpellHistory:UpdateMainIconSize() end end, nil, function() return not E.db.ProjectHopes.gcd.keepRatio end)
    POAMSA.gcd.args.settings.args.mainIconWidth = ACH:Range(L["Cast Icon Width"], L["Adjust the width of the Cast Icon"], 12, Private.Values.IconSize, nil, function() return E.db.ProjectHopes.gcd.mainIconWidth or 47 end, function(_, value) E.db.ProjectHopes.gcd.mainIconWidth = value if SpellHistory then SpellHistory:UpdateMainIconSize() end end, nil, function() return E.db.ProjectHopes.gcd.keepRatio end)
    POAMSA.gcd.args.settings.args.mainIconHeight = ACH:Range(L["Cast Icon Height"], L["Adjust the height of the Cast Icon"], 13, Private.Values.IconSize, nil, function() return E.db.ProjectHopes.gcd.mainIconHeight or 47 end, function(_, value) E.db.ProjectHopes.gcd.mainIconHeight = value if SpellHistory then SpellHistory:UpdateMainIconSize() end end, nil, function() return E.db.ProjectHopes.gcd.keepRatio end)
    
    -- History Icons Size Settings
    POAMSA.gcd.args.settings.args.historyIconHeader = ACH:Header(L["History Icons Size"], 20)
    POAMSA.gcd.args.settings.args.historyIconSize = ACH:Range(L["History Icons Size"], L["Adjust the size of the History icons (square)"], 21, Private.Values.IconSize, nil, function() return E.db.ProjectHopes.gcd.historyIconSize end, function(_, value) E.db.ProjectHopes.gcd.historyIconSize = value if SpellHistory then SpellHistory:UpdateHistoryIconSize() end end, nil, function() return not E.db.ProjectHopes.gcd.keepRatio end)
    POAMSA.gcd.args.settings.args.historyIconWidth = ACH:Range(L["History Icons Width"], L["Adjust the width of the History icons"], 22, Private.Values.IconSize, nil, function() return E.db.ProjectHopes.gcd.historyIconWidth or 36 end, function(_, value) E.db.ProjectHopes.gcd.historyIconWidth = value if SpellHistory then SpellHistory:UpdateHistoryIconSize() end end, nil, function() return E.db.ProjectHopes.gcd.keepRatio end)
    POAMSA.gcd.args.settings.args.historyIconHeight = ACH:Range(L["History Icons Height"], L["Adjust the height of the History icons"], 23, Private.Values.IconSize, nil, function() return E.db.ProjectHopes.gcd.historyIconHeight or 36 end, function(_, value) E.db.ProjectHopes.gcd.historyIconHeight = value if SpellHistory then SpellHistory:UpdateHistoryIconSize() end end, nil, function() return E.db.ProjectHopes.gcd.keepRatio end)
