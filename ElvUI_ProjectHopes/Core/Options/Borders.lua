...
function ProjectHopes:Borders()
  local POA = ProjectHopes.Options.args
	...
	POABS.UnitFrames.args.raid1border.args.raid = ACH:Toggle(L["Heal"], nil, 3, nil, false, "full", function() return E.db.ProjectHopes.border.raid end, function(_, value) E.db.ProjectHopes.border.raid = value if value then E.db.ProjectHopes.border.raiddps = false end E:StaticPopup_Show('ProjectHopes_RL') end, function() return not E.db.unitframe.units.raid1.enable end, function() return E.db.ProjectHopes.border.raiddps end)
	...
	POABS.UnitFrames.args.raid1border.args.raiddps = ACH:Toggle(L["DPS/TANK"], nil, 5, nil, false, "full", function() return E.db.ProjectHopes.border.raiddps end, function(_, value) E.db.ProjectHopes.border.raiddps = value if value then E.db.ProjectHopes.border.raid = false E.db.ProjectHopes.border.raidbackdrop = false end E:StaticPopup_Show('ProjectHopes_RL') end, function() return not E.db.unitframe.units.raid1.enable end, function() return E.db.ProjectHopes.border.raid end)
	...
	POABS.UnitFrames.args.raid2border.args.raid = ACH:Toggle(L["Heal"], nil, 3, nil, false, "full", function() return E.db.ProjectHopes.border.raid2 end, function(_, value) E.db.ProjectHopes.border.raid2 = value if value then E.db.ProjectHopes.border.raid2dps = false end E:StaticPopup_Show('ProjectHopes_RL') end, function() return not E.db.unitframe.units.raid2.enable end, function() return E.db.ProjectHopes.border.raid2dps end)
	...
	POABS.UnitFrames.args.raid2border.args.raiddps = ACH:Toggle(L["DPS/TANK"], nil, 5, nil, false, "full", function() return E.db.ProjectHopes.border.raid2dps end, function(_, value) E.db.ProjectHopes.border.raid2dps = value if value then E.db.ProjectHopes.border.raid2 = false E.db.ProjectHopes.border.raid2backdrop = false end E:StaticPopup_Show('ProjectHopes_RL') end, function() return not E.db.unitframe.units.raid2.enable end, function() return E.db.ProjectHopes.border.raid2 end)
	...
	POABS.UnitFrames.args.raid3border.args.raid = ACH:Toggle(L["Heal"], nil, 3, nil, false, "full", function() return E.db.ProjectHopes.border.raid3 end, function(_, value) E.db.ProjectHopes.border.raid3 = value if value then E.db.ProjectHopes.border.raid3dps = false end E:StaticPopup_Show('ProjectHopes_RL') end, function() return not E.db.unitframe.units.raid3.enable end, function() return E.db.ProjectHopes.border.raid3dps end)
	...
	POABS.UnitFrames.args.raid3border.args.raiddps = ACH:Toggle(L["DPS/TANK"], nil, 5, nil, false, "full", function() return E.db.ProjectHopes.border.raid3dps end, function(_, value) E.db.ProjectHopes.border.raid3dps = value if value then E.db.ProjectHopes.border.raid3 = false E.db.ProjectHopes.border.raid3backdrop = false end E:StaticPopup_Show('ProjectHopes_RL') end, function() return not E.db.unitframe.units.raid3.enable end, function() return E.db.ProjectHopes.border.raid3 end)
